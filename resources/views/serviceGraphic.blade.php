    ...
    <body class="no-scrollbar">
        <section class="OverOns">
            ...
            <section class="about-text">
                ...
                <p class="white-text">
                    Kies Uneed-IT voor een professionele reparatieservice waarop u kunt vertrouwen. We staan klaar om u te helpen met al uw reparatiebehoeftes.
                </p>
            </section>
        </section>
    </body>
